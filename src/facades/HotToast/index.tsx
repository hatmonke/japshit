...
function TailwindToast({
  ...
  return (
    <Transition
      ...
      leaveTo="opacity-0"
      className={`pointer-events-auto flex w-full max-w-md rounded border border-primary bg-bgbase shadow-lg ring-1 ring-black ring-opacity-5`}
    >
      ...
      <div className="flex border-l border-secondary">
        <button
          ...
          className="flex w-full items-center justify-center rounded-none rounded-r-lg border border-transparent p-4 text-sm font-medium text-secondary hover:text-secondary/80 focus:outline-none focus:ring-2 focus:ring-secondary/80"
        >
          Close
        </button>
      </div>
